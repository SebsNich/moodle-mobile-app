...
export default function LoginScreen({ navigation }) {
    ...
    const handleLoginPress = async () => {
        ...
        // STEVEN: reemplazar googleToken con el token real de Google OAuth 2.0
        // Pasos para Steven:
        // 1. Crear proyecto en Google Cloud Console
        // 2. Habilitar Google Sign-In API
        // 3. Obtener androidClientId y webClientId
        // 4. Instalar expo-auth-session y reemplazar esta función
        ...
        if (response.token) {
            ...
            Alert.alert("Error", "No se pudo iniciar sesión en Moodle.");
        }
        } catch (error) {
